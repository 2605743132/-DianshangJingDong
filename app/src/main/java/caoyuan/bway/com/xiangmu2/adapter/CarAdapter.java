...
import caoyuan.bway.com.xiangmu2.view.AddandSub;
...
public class CarAdapter extends RecyclerView.Adapter<CarAdapter.MyCarViewHolder> {
    ...
    private List<CharBean.ResultBean> carlist;


    public CarAdapter(Context context, List<CharBean.ResultBean> carlist) {
    ...
    public void onBindViewHolder(@NonNull final MyCarViewHolder holder, final int position) {
        final CharBean.ResultBean resultBean = carlist.get(position);
